...
// Frequency of message updates (60 seconds)
...
// Generates message and updates screen
void printScreen(ZonedDateTime localTime)
{
    ...
    // If an entry for the current date exists in the message file, load it
    ...
    // If there is no entry for the curretn date in the message file, generate an ad-hoc one
    else
    {
    ...
    // Display the date and message to the screen
    Serial.println(text);
    display.clearBuffer();
